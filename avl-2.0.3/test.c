...
/*
测试命令
root@zhong1:/home/code/github/chenzhongtao/source/avl-2.0.3# ./bst-test -v -r 1
bst-test for GNU libavl 2.0.3; use --help to get help.
Testing seed=20186...
  Insertion order: 10 12 4 5 1 3 6 9 7 0 13 11 8 14 2.
Deletion order: 1 4 2 14 11 7 3 0 8 10 13 12 6 9 5.
  No errors.
  No memory leaks.


root@zhong1:/home/code/github/chenzhongtao/source/avl-2.0.3# ./bst-test -v -v -r 1 -t overflow 
bst-test for GNU libavl 2.0.3; use --help to get help.
Testing seed=9922...
  Insertion order: 4 1 6 0 14 10 2 8 12 7 3 5 13 11 9.
  Running first item test...
  Running last item test...
  Running find item test...
  Running insert item test...
  Running next item test...
  Running previous item test...
  Running copy tree test...
  No errors.
  No memory leaks.
