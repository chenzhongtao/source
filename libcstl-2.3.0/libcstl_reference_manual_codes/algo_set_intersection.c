...
int main(int argc, char* argv[])
{
     ...
     */
    it_result = algo_set_intersection_if(vector_begin(pvec_v2a), vector_end(pvec_v2a),
     ...
     */
    it_result = algo_set_intersection_if(vector_begin(pvec_v3a), vector_end(pvec_v3a),
        vector_begin(pvec_v3b), vector_end(pvec_v3b), vector_begin(pvec_v3),
        _mod_lesser);
    printf("Intersection of source ranges with binary predicate mod_lesser order\n"
           "vector v3 = ( ");
