...
int main(int argc, char* argv[])
{
    ...
    {
        printf("The hash_multiset hs1 is less than or equal to the hash_multiset hs2.\n");
    }
    else
    {
    ...
    {
        printf("The hash_multiset hs1 is less than or equal to the hash_multiset hs3.\n");
    }
    else
    {
    ...
    {
        printf("The hash_multiset hs1 is less than or equal to the hash_multiset hs4.\n");
    }
    else
    {
