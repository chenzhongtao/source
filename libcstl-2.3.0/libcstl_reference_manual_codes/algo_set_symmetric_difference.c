...
int main(int argc, char* argv[])
{
     ...
     */
    it_result = algo_set_symmetric_difference(vector_begin(pvec_v1a), vector_end(pvec_v1a),
     ...
     */
    it_result = algo_set_symmetric_difference_if(vector_begin(pvec_v2a), vector_end(pvec_v2a),
        vector_begin(pvec_v2b), vector_end(pvec_v2b), vector_begin(pvec_v2),
        fun_greater_int);
    printf("Symmetric difference of source ranges with binary predicate greater order\n"
           "vector v2 = ( ");
     ...
     */
    it_result = algo_set_symmetric_difference_if(vector_begin(pvec_v3a), vector_end(pvec_v3a),
        vector_begin(pvec_v3b), vector_end(pvec_v3b), vector_begin(pvec_v3),
        _mod_lesser);
    printf("Symmetric difference of source ranges with binary predicate mod_lesser order\n"
           "vector v3 = ( ");
