...
int main(int argc, char* argv[])
{
    ...
    it_v = algo_upper_bound_if(vector_begin(pvec_v2), vector_end(pvec_v2), 3, fun_greater_int);
    ...
    it_v = algo_upper_bound_if(vector_begin(pvec_v3), vector_end(pvec_v3), 3, _mod_lesser);
