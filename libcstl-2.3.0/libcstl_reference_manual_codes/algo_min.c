...
int main(int argc, char* argv[])
{
    ...
    it_v = algo_min_if(vector_begin(pvec_v1), iterator_next(vector_begin(pvec_v1)), fun_greater_set);
    ...
    it_v = algo_min_if(vector_begin(pvec_v1), iterator_prev(vector_end(pvec_v1)), fun_greater_set);
