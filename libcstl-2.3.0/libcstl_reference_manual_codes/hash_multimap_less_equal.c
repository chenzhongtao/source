...
int main(int argc, char* argv[])
{
    ...
    {
        printf("The hash_multimap hmm1 is less than or equal to the hash_multimap hmm2.\n");
    }
    else
    {
    ...
    if(hash_multimap_less_equal(phmm_hmm1, phmm_hmm3))
    {
        printf("The hash_multimap hmm1 is less than or equal to the hash_multimap hmm3.\n");
    }
    else
    {
    ...
    if(hash_multimap_less_equal(phmm_hmm1, phmm_hmm4))
    {
        printf("The hash_multimap hmm1 is less than or equal to the hash_multimap hmm4.\n");
    }
    else
    {
        printf("The hash_multimap hmm1 is greater than the hash_multimap hmm4.\n");
    }
