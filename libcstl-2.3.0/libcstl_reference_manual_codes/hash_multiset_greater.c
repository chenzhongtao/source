...
int main(int argc, char* argv[])
{
    ...
    if(hash_multiset_greater(phms_hms1, phms_hms2))
    {
        printf("The hash_multiset hs1 is greater than the hash_multiset hs2.\n");
    }
    else
    {
        printf("The hash_multiset hs1 is not greater than the hash_multiset hs2.\n");
    }

    if(hash_multiset_greater(phms_hms1, phms_hms3))
    {
        printf("The hash_multiset hs1 is greater than the hash_multiset hs3.\n");
    }
    else
    {
        printf("The hash_multiset hs1 is not greater than the hash_multiset hs3.\n");
    }
