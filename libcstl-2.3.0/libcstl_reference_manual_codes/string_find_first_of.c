...
int main(int argc, char* argv[])
{
    ...
    if(t_pos != NPOS)
    {
        printf("The index of the 1st occurrence of an element of 'ba3' in str1a after the 5th position is %u.\n", t_pos);
    }
    else
    {
    ...
    if(t_pos != NPOS)
    {
        printf("The index of the 1st occurrence of an element of 'a2' in str1a position is %u.\n", t_pos);
    }
    else
    {
    ...
    if(t_pos != NPOS)
    {
        printf("The index of the 1st occurrence of an element of 'B1' in str2a after the 6th position is %u.\n", t_pos);
    }
    else
    {
    ...
    if(t_pos != NPOS)
    {
        printf("The index of the 1st occurrence of an element of 'D2' in str2a position is %u.\n", t_pos);
    }
    else
    {
    ...
    if(t_pos != NPOS)
    {
        printf("The index of the 1st occurrence of an element of '5G' in str3a is %u.\n", t_pos);
    }
    else
    {
    ...
    if(t_pos != NPOS)
    {
        printf("The index of the 1st occurrence of an element of '5GF' in str3a position is %u.\n", t_pos);
    }
    else
    {
        printf("Elements other than those in the substring '5GF' were not found in the string str3a.\n");
    }
    ...
    if(t_pos != NPOS)
    {
        printf("The index of the 1st occurrence of an element of 'd' in str4a is %u.\n", t_pos);
    }
    else
    {
    ...
    if(t_pos != NPOS)
    {
        printf("The index of the 1st occurrence of an element of 'x' in str4a position is %u.\n", t_pos);
    }
    else
    {
